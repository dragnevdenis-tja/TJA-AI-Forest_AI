...
def main():
    ...
    if args.self_learn:
        ...
        wrapper_path = os.path.join(os.getcwd(), "forest-audio-web", "app", "model_wrapper.py")
        if not os.path.exists(wrapper_path):
            # Try underscored version just in case
            wrapper_path = os.path.join(os.getcwd(), "forest_audio_web", "app", "model_wrapper.py")
